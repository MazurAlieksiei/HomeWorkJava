...
public class CalculatorWithCounterAutoDecoratorTests {
    ...
    public void getCountOperation() {
        Assertions.assertEquals(0, ((CalculatorWithCounterAutoDecorator) iCalculator).getCountOperation());
        iCalculator.abs(-4);
        Assertions.assertEquals(1, ((CalculatorWithCounterAutoDecorator) iCalculator).getCountOperation());
    }
}
